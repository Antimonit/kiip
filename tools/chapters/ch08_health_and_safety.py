...
CHAPTER = dict(
    ...
    blocks=[
        ...
        SECTION("part", "01 한국에서 의료기관은 어떻게 이용할까?"),
        ...
        PARAGRAPH("{서양 의학} 이외에 한국의 전통 의학을 활용한 한의원이나 {한방} 병원도 이용할 수 있다. 여기 서는 "
        ...
        GLOSSARY(("재난", "뜻밖에 일어난 재앙과 고난", "재난"),
              ...
              ("매뉴얼",
              "직무를 수행하는 데 필요한 작업상의 지식이나 작업진행 방법 등에 관한 기본적인 사항 을 체계적으로 정리학 " "것",
              "매뉴얼"),
              ("대응", "어떤 일이나 사태에 맞추어 태 도나 행동을 취함", "대응"),
        ...
        PARAGRAPH("한국은 국가 재난 관리를 담당하는 {행정안전부}를 중심으로 중앙 {부처}•{지방 자치 단체}•공공 7관이 "
          ...
          "원전안전사고 등에 대한 대응 매뉴얼을 직접 실천하는 기회를 가지고 있다."),
        PARAGRAPH("일상생활에서 각 {개인}이 재난에 대비하고 대응하는 노력도 중요하다. 긴급한 재난이나 큰 사고가 발생했을 "
          "때는 긴급신고전화등을 통해 현재 자신의 위치와 사고 상황을 자세히 설명해야 한다."),
        ...
        PARAGRAPH("혹시 누군가가 어린이에게 물래 다가가 어린이의 안전을 해지고 달아나거나 사람이 없는 밤 시간에 자동차 "
          ...
          "차량 번호 등을 지능적으로포착해서 분석하게 되면 누가 잘못을 했고 누가 피해를 입었는지 알 수 있다. "
          "한국 정부와 각 지방의 시, 군, 구에서 설치한 스마트 CCTV 시스템은 단지 범죄자 추적만이 아니라 "
          "안전을 해치는 행위를 사전에 발견하여 예방하는 데도기여할 수 있다."),
    ...
    fixes=[
        ("한국에서 의료기관은", "한국에서 의료 기관은",
         "spacing — the review heading for the same article has it open"),
        ("건강 보험 제도를", "건강보험 제도를", "spacing — set closed elsewhere in the sentence"),
        ("여기 서는", "여기서는", "spacing"),
        ("원전안전사고", "원전 안전사고", "spacing"),
        ("으로포착해서", "으로 포착해서", "spacing"),
        ("데도기여할", "데도 기여할", "spacing"),
        ("사항 을", "사항을", "spacing"),
        ("정리학 것", "정리한 것", "typo — 학 for 한"),
        ("태 도나", "태도나", "spacing"),
        ("=•", "·", "bullet used for a middle dot"),
        ("•공공 7관", "·공공 기관", "bullet used for a middle dot, and 7 for 기"),
        ("긴급신고전화등을", "긴급신고전화 등을", "spacing"),
        ("=살피고", "살피고 ", "missing space, lost at an annotation boundary",
         ("살피고그러한", "살피고 그러한")),
        ("물래 다가가", "몰래 다가가", "typo — 물래 for 몰래"),
        ("안전을 해지고", "안전을 해치고", "typo — 해지고 for 해치고"),
        ("안전•보건", "안전·보건", "bullet used for a middle dot"),
