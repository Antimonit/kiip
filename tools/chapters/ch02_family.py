...
CHAPTER = dict(
    ...
    blocks=[
        ...
        HEADING(4, "01 한국에서 많이 본 가족은 어떤 모습입니까?"),
        ...
        TABLE([CELL("영역", columns=2), "제목", "관련 내용"], [["기본", "법", "33. 가족과 법",
              "부부로 인정받기 위한 절차, 부부의 권리와 의무"],
              ["심화", "역사", "8. 사회변동", "저출산 현상, 고령화 사회"],
              ["심화", "법", "17. 가족문제와 법", "가족과 친족, 이혼"]]),
        SECTION("part", "01 한국의 가족은 어떤 특징을 가지고 있을까?"),
        ...
        GLOSSARY(("유대관계", "둘 이상을 서로 연결하거나 결합하는 관계", "유대관계"),
              ("제삿날", "조상이 돌아가신 날을 기억하며 음식을 차려 조상에게 드리는 날", "제삿날"),
