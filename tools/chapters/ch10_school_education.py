...
CHAPTER = dict(
    ...
    extraNotes=[
        "Chapter 10 is the one chapter with a Doc that is not used. That Doc "
        "carries no comments at all and six typos the photos do not have, so "
        "the Korean here is transcribed from the photos of pp. 58-61 and the "
