...
CHAPTER = dict(
    ...
    blocks=[
        ...
        BULLET("한국의 영유아 보육·교육 기관에 대하여 알 수 있다.", ordered=True),
        ...
        PARAGRAPH("어린이집 보육 시간은 오전 9시부터 오후 4시까지의 ‘기본 보육’과 오후 4시부터 오후 7시 30분까지 "
        ...
        HEADING(2, "유치원", translation="Kindergarten" "\n\n"
          ...
          "time after applying."),
        GLOSSARY(("관할", "일정한 권한을 가지고 통제하거나 지배함", "관할"),
        ...
        PARAGRAPH("이외에 야간 돌봄이 필요한 영유아들을 권역별로 지정된 거점형 야간보육 어린이집에서 전담 보육교사가 함께 "
        ...
        BULLET("(   )은 0세부터 만 5세까지 아이들의 보육과 교육을 담당하며 (   )에서 지정한 시설이다."),
