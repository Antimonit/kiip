...
CHAPTER = dict(
    ...
    blocks=[
        ...
        HEADING(4, "01 자신의 고향 나라에서는 이런 경우 어떻게 대응 합니까?"),
        HEADING(4, "02 본인은 한국에서 이와 같은 상황에 대비하여 무 엇을 준비하고 있습니까?"),
        SECTION("goals", "학습목표"),
        ...
        HEADING(2, "사회보험", translation="Social Insurance" "\n\n"
          ...
          "expenses." "\n\n"
          "Industrial Accident Compensation Insurance (산업재해 보상보험)" "\n\n"
        ...
        TABLE(["건강보험", "아파서 병원에 갈 때 의료비의 일부를 지원 받을 수 있다."], [["고용보험",
              "회사에서 해고되었을 때 일정 기간 금전적 지원을 받을 수 있다"],
              ["국민연금", "나이가 들어 더 이상 돈을 벌기 어려울 때 매달 일정 금액을 생활비로 지급 받을 수 있다."],
              ["산업재해 보상보험", "회사에서 일하다가 사고로 다쳤을 때 병원비 등 피해에 대해 보상을 받을 수 있다."]]),
        BULLET("개인보험"),
        BULLET("생명보험", level=2),
        BULLET("손해보험", level=2),
        BULLET("고육보험", level=2),
        ...
        GLOSSARY(("최저 생계비", "생활에 필요한 최소한의 비용"),
              ...
              ("생계", "살아 나가는 형편"),
              ("긴급", "중요하고 급함")),
        PARAGRAPH("공공부조는 생활이 어려운 사람들의 기본적인 생활 수준을 보장 해주기 위해 국가나 지방자치단체에서 생활비, "
          "교육비, 의료비 등을 지원해 주는 제도이다. 소득이 최저 생계비 보다 적은 저소득층은 국민 기초생활보장 "
        ...
        MARGIN("보건복지부", "상담센터(☎ 129)",
               "본인과 가족에게 필요한 복지 정보와 상담을 원할 때는 129 로 전화하면 된다.",
    ...
    fixes=[
        ("어떻게 대응 합니까", "어떻게 대응합니까", "spacing"),
        ("무 엇을", "무엇을", "spacing"),
        ("=고육보험", "교육보험", "typo — 고육 for 교육 in the 개인보험 list"),
        ("산업재해 보상보험", "산업재해보상보험", "spacing — set closed elsewhere on the page"),
        ("보장 해주기", "보장해주기", "spacing"),
        ("최저 생계비 보다", "최저 생계비보다", "spacing"),
        ("129 로 전화하면", "129로 전화하면", "spacing"),
        ("옮겨 가 서", "옮겨 가서", "spacing"),
        ("화공말이", "한국말이", "typo — 화공 for 한국"),
        ("법사랑위원회", "법사랑 위원회", "spacing"),
        ("가족•", "가족·", "bullet used for a middle dot"),
        ("* 본인이", "★ 본인이", "the page uses a star for the discussion prompt"),
    ],
    approved={
        # read against the photos of pp. 40-43 and accepted
        "어떻게 대응 합니까", "무 엇을", "산업재해 보상보험", "=고육보험",
        "보장 해주기", "최저 생계비 보다", "129 로 전화하면", "옮겨 가 서",
        "가족•", "화공말이", "법사랑위원회", "* 본인이",
    },
