...
CHAPTER = dict(
    ...
    blocks=[
        ...
        GLOSSARY(("학교 생활 기록부",
              ...
              ("재외국민", "국외에 거주하고 있으나 국적 을 유지하고 있는 국민", "재외국민")),
        PARAGRAPH("대학에 진학하고자 할 때는 학교 생활 기록부를 중심으로 하는 수시 모집에 진원하거나 대학 수학 능력 "
          "시험에 응시하여 나온 결과인 수능 성적을 중심으로 하는 정시 모집에 지원 할 수 있다. 대학 수학 능력 "
        ...
        PARAGRAPH("한국의 고등 교육 기관으로는 대학교와 대학원이 있다. 대학교에서는 학사 학위를, 대학원에서는 석사 학위와 "
          "박사학위를 받을 수 있다."),
        PARAGRAPH("대학교에는 4년제 종합대학교, 교육대학교, 전문대학교, 방송통신대학교, 사이버대한교, 기술대학교 등이 "
          "있다. 4년제 중합대학교는 인문학, 사회과학, 법학, 자연과학, 공학, 의학 등 다양한 분야의 학문을 "
        ...
        HEADING(2, "대학원"),
        GLOSSARY(("전문성", "어떤 영역에서 보통 수준 이상 의 수행 능력을 보이는 것")),
        ...
        PARAGRAPH("기초 학문 연구와 교육을 주로 하는 일반대학원과 경영대학원·교육대학원·행정대학원·통역대학원·환경대학원 등 "
          ...
          "수업을 진행하여 직장인의 전문성확보를 지원하는 특수대학원이 있다."),
        ...
        PARAGRAPH("최근 몇 년간 한국 내 대학의 외국인 유학생 비율은 점점 늘어나고 있는 추세이다. 한국교육 개발원이 "
    ...
    fixes=[
        ("초•중등 교육", "초·중등 교육", "bullet used for a middle dot"),
        ("차지 하는 위치", "차지하는 위치", "spacing"),
        ("국적 을 유지", "국적을 유지", "spacing"),
        ("진원하거나", "지원하거나", "typo — 진원 for 지원"),
        ("정시 모집에 지원 할", "정시 모집에 지원할", "spacing"),
        ("일아두면 좋아요", "알아두면 좋아요", "typo — 일아 for 알아"),
        ("학교적응", "학교 적응", "spacing"),
        ("재학중인", "재학 중인", "spacing"),
        ("=학뷔", "학위", "typo — 뷔 for 위"),
        ("사이버대한교", "사이버대학교", "typo — 대한 for 대학"),
        ("4년제 중합대학교", "4년제 종합대학교", "typo — 중합 for 종합"),
        ("보통 수준 이상 의", "보통 수준 이상의", "spacing"),
        ("전문성확보", "전문성 확보", "spacing"),
        ("한국교육 개발원", "한국교육개발원", "spacing — it is one institute's name"),
    ],
