...
CHAPTER = dict(
    ...
    append=[
        ...
        PARAGRAPH("다음은 사회통합프로그램 수업 교실 모습입니다. 학생들이 스마트폰 사용 {규칙}을 "
          "정하자는 {의견}이 나왔습니다."),
        ...
        PARAGRAPH("‘{정치}’하면 무엇이 {떠오르는가|떠오르다}? 누군가는 {선거}를 떠올리고 누군가는 "
          ...
          "{이해관계}를 {조정}하는 것을 가리킨다. 학교나 회사에서 어떤 {규칙}을 정하는 것, "
        ...
        BULLET("넓은 의미의 (        )는 일상생활에서 사람들 사이의 서로 다른 이해관계를 조정하는 "
          "것이다."),
        BULLET("오늘날 한국에서는 (        ) 원리에 따라 모든 국민이 차별 없이 자유롭게 한국 사회에 "
          "대해 다양한 목소리를 표출하고 해결 과정에 참여할 수 있다."),
        BULLET("한국에서는 특정 개인이나 정치인이 아니라 한국 국민이 (        )을 가지고 있다."),
        HEADING(3, "02 한국은 왜 국가 기관의 권력을 나누어 놓았을까?"),
        BULLET("한국은 민주주의 실현을 위해서 국가 권력을 (        ), (        ), (        )으로 "
          "나누어 놓았다."),
        BULLET("국가 권력을 여러 기관으로 나누는 것을 (        ) 원칙이라고 한다. 한국은 국가 권력을 "
          "세 개로 분리해 놓았다는 점에서 (        )이라고도 한다."),
        BULLET("입법부는 국가 운영의 기본이 되는 법을 (        )하고 행정부는 법에 따라 정책을 "
          "(        )하며 사법부는 법을 해석하고 (        )하여 재판을 한다."),
    ...
    extraAnnotations={
        ...
        "규칙": dict(
            hanja="規則", meaning="a rule",
            characters=[("規", "규", "rule, compass — as in 규제, 대규모"),
                        ("則", "칙", "rule, law — as in 원칙 “principle”")],
        ),
        "회의": dict(
    ...
    extraNotes=[
        ...
        "Where the unit changes from 문화 to 정치, and the first chapter of "
        "제4편.",
