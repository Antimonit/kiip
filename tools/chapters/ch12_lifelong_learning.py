...
CHAPTER = dict(
    ...
    blocks=[
        ...
        TABLE(["영역", "내용"], [["기초 문해 교육", "문자를 읽고 쓰고 셈하는 기초 능력"],
              ...
              ["직업 능력 교육", "근로자의 직무 능력을 향상시키거나 실업자의 취 업이나 창업 지원"],
        ...
        GLOSSARY(("평생 학습 계좌제 누리집", "http://www.all.go.kr"),
              ...
              ("평생 교육 바우처 지원", "https://www.Illcard.kr")),
        ...
        PARAGRAPH("국가평생학습포털 늘배움(www.lfelongedu.go.kr)은 누구나, 언제, 어디서나 원하는 평생 "
          "학습 정보를 이용할 수 있는 평생 교육 종합 정보 시스템이다. 그동안의 평생 교육은 오프라인 프로그램 "
          "중심으로 운영되어 수요자 요구에 부합하는 체계적이고 종합적인 평생 학습 지원에는 한계가 있었다. 평생 "
          "학습 참여 기회가 부족한 소외계층이나 평생 교육 기반이 부족한 지역 주민을 포함하여 전 국민이 시간과 "
        ...
        PARAGRAPH("사회통합프로그램은 국내 이민자가 한국 사회의 능동적인구성원으로 적응하고 자립할 수 있도록 지인하기 위하여 "
          "법무부장관이 인정하는 교육 과졍(한국어와 한국 문화 및 한국 사회 이해)을 이수한 이민자에게 체류허가나 "
          "국적 취득 시 혜택을 주는 제도이다."),
        PARAGRAPH("또한, 중도 입국 청소년과 외국인 학생을 위한 교육 지원으로 다문화 학생 언어 발달 지원 및 다문화 가정 "
          "방문 교육, 다문화 학생의 정체성 회복 및 사회성함양 지원, 직업 훈련을 통한 이주 배경 청소년의 자립 "
        ...
        PARAGRAPH("이외에도 한국산업인력공단 외국인고용지원센터에서는 체류 기간이 끝나도 한국에 안정적으로 재정착할 수 있도록 "
          "입국 후 3년 이상 된 외국인근로자를 대상으로 자동차 정비, 중장비운전, 용접, 전기•전자, 한식 조리, "
    ...
    fixes=[
        ("( … )", "(        )",
         "the Doc marks the review gaps with an ellipsis; the book leaves them empty"),
        ("경제•사회", "경제·사회", "bullet used for a middle dot"),
        ("실업자의 취 업이나", "실업자의 취업이나", "spacing"),
        ("국가평생 교육진흥원", "국가평생교육진흥원", "spacing — it is one institute's name"),
        ("평생 교육원외에도", "평생 교육원 외에도", "spacing"),
        ("https://www.Illcard.kr", "https://www.lllcard.kr",
         "capital I for the three lower-case l of 평생학습(lifelong learning)"),
        ("www.lfelongedu.go.kr", "www.lifelongedu.go.kr", "typo — lfelong for lifelong"),
        ("소외계층이나", "소외 계층이나", "spacing — set open elsewhere on the page"),
        ("-> 회원가입 프로그램", "→ 회원가입 → 프로그램",
         "the arrows in the sign-up path, one of them lost"),
        ("상호 문화 이해 (부부 교육)", "상호 문화 이해(부부 교육)", "spacing"),
        ("능동적인구성원", "능동적인 구성원", "spacing"),
        ("자립할 수 있도록 지인하기", "자립할 수 있도록 지원하기", "typo — 지인 for 지원"),
        ("법무부장관", "법무부 장관", "spacing"),
        ("교육 과졍", "교육 과정", "typo — 과졍 for 과정"),
        ("사회성함양", "사회성 함양", "spacing"),
        ("중장비운전", "중장비 운전", "spacing"),
        ("전기•전자", "전기·전자", "bullet used for a middle dot"),
        ("누적•관리", "누적·관리", "bullet used for a middle dot"),
        ("수강인원에", "수강 인원에", "spacing"),
        ("http:/www.cb.or.kr", "http://www.cb.or.kr", "one slash missing from the URL"),
